...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
		...
		try {
			...
			PreparedStatement ps = (PreparedStatement) conn.prepareStatement("insert into test.customer_master(customer_code, customer_name, product_group, customer_id , SalesPerson, instruction) VALUES (?,?,?,?,?,?)");
